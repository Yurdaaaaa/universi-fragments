...
public final class ActionBarDelegateSupportTest extends RobolectricTestCase {
	...
	public void testSetDisplayHomeAsUpEnabled() {
		...
		final ActionBarDelegate delegate = new ActionBarDelegate.SupportImpl(mApplication, mockActionBar);
	...
	public void testSetDisplayHomeAsUpEnabledWithoutActionBar() {
		...
		new ActionBarDelegate.SupportImpl(mApplication, null).setDisplayHomeAsUpEnabled(true);
	}
	...
	public void testSetHomeAsUpVectorIndicatorWithoutActionBar() {
		// Only ensure that the delegate does not cause any troubles when it does not have ActionBar.
		new ActionBarDelegate.SupportImpl(mApplication, null).setHomeAsUpIndicator(android.R.drawable.ic_delete);
	}
	...
	public void testSetHomeAsUpIndicator() {
		final android.support.v7.app.ActionBar mockActionBar = mock(android.support.v7.app.ActionBar.class);
		final ActionBarDelegate delegate = new ActionBarDelegate.SupportImpl(mApplication, mockActionBar);
		final Drawable indicator = mApplication.getResources().getDrawable(android.R.drawable.ic_delete);
	...
	public void testSetHomeAsUpIndicatorWithoutActionBar() {
		// Only ensure that the delegate does not cause any troubles when it does not have ActionBar.
		new ActionBarDelegate.SupportImpl(mApplication, null).setHomeAsUpIndicator(mApplication.getResources().getDrawable(android.R.drawable.ic_delete));
	}
	...
	public void testSetTitleWithoutActionBar() {
		// Only ensure that the delegate does not cause any troubles when it does not have ActionBar.
		new ActionBarDelegate.SupportImpl(mApplication, null).setTitle("Title");
	}
	...
	public void testSetIconAsResourceWithoutActionBar() {
		// Only ensure that the delegate does not cause any troubles when it does not have ActionBar.
		new ActionBarDelegate.SupportImpl(mApplication, null).setIcon(android.R.drawable.ic_delete);
	}
	...
	public void testSetIconWithoutActionBar() {
		// Only ensure that the delegate does not cause any troubles when it does not have ActionBar.
		new ActionBarDelegate.SupportImpl(mApplication, null).setIcon(null);
	}
}
