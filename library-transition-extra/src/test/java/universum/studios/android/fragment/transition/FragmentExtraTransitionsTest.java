...
public final class FragmentExtraTransitionsTest extends AndroidTestCase {
	...
	public void testInstantiation() throws Exception {
		// Act:
		FragmentExtraTransitions.class.newInstance();
	}

	@Test(expected = InvocationTargetException.class)
	public void testInstantiationWithAccessibleConstructor() throws Exception {
		// Arrange:
		final Constructor<FragmentExtraTransitions> constructor = FragmentExtraTransitions.class.getDeclaredConstructor();
	...
	@Test public void testSCALE_IN_AND_SLIDE_TO_LEFT() {
		// Assert:
		assertThatTransitionHasAttributes(FragmentExtraTransitions.SCALE_IN_AND_SLIDE_TO_LEFT,
	...
	@Test public void testSCALE_IN_AND_SLIDE_TO_RIGHT() {
		// Assert:
		assertThatTransitionHasAttributes(FragmentExtraTransitions.SCALE_IN_AND_SLIDE_TO_RIGHT,
				R.animator.fragment_scale_in,
	...
	@Test public void testSCALE_IN_AND_SLIDE_TO_TOP() {
		// Assert:
		assertThatTransitionHasAttributes(FragmentExtraTransitions.SCALE_IN_AND_SLIDE_TO_TOP,
				R.animator.fragment_scale_in,
	...
	@Test public void testSCALE_IN_AND_SLIDE_TO_BOTTOM() {
		// Assert:
		assertThatTransitionHasAttributes(FragmentExtraTransitions.SCALE_IN_AND_SLIDE_TO_BOTTOM,
				R.animator.fragment_scale_in,
	...
	@Test public void testSLIDE_TO_LEFT_AND_SCALE_OUT() {
		// Assert:
		assertThatTransitionHasAttributes(FragmentExtraTransitions.SLIDE_TO_LEFT_AND_SCALE_OUT,
	...
	@Test public void testSLIDE_TO_RIGHT_AND_SCALE_OUT() {
		// Assert:
		assertThatTransitionHasAttributes(FragmentExtraTransitions.SLIDE_TO_RIGHT_AND_SCALE_OUT,
	...
	@Test public void testSLIDE_TO_TOP_AND_SCALE_OUT() {
		// Assert:
		assertThatTransitionHasAttributes(FragmentExtraTransitions.SLIDE_TO_TOP_AND_SCALE_OUT,
	...
	@Test public void testSLIDE_TO_BOTTOM_AND_SCALE_OUT() {
		// Assert:
		assertThatTransitionHasAttributes(FragmentExtraTransitions.SLIDE_TO_BOTTOM_AND_SCALE_OUT,
